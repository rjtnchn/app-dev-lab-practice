...
| Backend A | Aaron | Implement `api/create.php` + `api/read.php` | `feature/backend-create-read` |
| Backend B | Johnpaul | Implement `api/update.php` + `api/delete.php` | `feature/backend-update-delete` |
| Frontend A | Joshua | Implement `renderTasks()` in `public/js/app.js` | `feature/frontend-list-view` |
| Frontend B | Shane | Implement `handleCreate/Update/Delete()` in `public/js/app.js` | `feature/frontend-form-crud` |
